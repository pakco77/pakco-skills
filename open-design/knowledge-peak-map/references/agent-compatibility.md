...
```bash
npx skills add pakco77/pakco-skills \
...
```bash
npx skills add pakco77/pakco-skills --list --full-depth
```
...
| CodeWhale | `/skill install github:pakco77/pakco-skills` or place it in a discovered Skills directory | project `.agents/skills/knowledge-peak-map`; global `~/.codewhale/skills/knowledge-peak-map` |
...
5. Test repository discovery with `npx skills add pakco77/pakco-skills --list --full-depth`.
