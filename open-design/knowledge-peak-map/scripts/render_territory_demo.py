...
<nav class="tools" id="tools" aria-label="地图控制台"><div class="control-head"><span>CONTROL</span><i>ON</i></div><button class="tool" id="setup" type="button"><b>01</b><span>SET</span><small id="setup-label">设置</small></button><button class="tool" id="language" type="button"><b>02</b><span>LANG</span><small id="language-label">EN</small></button><a class="tool" href="https://github.com/pakco77/pakco-skills/tree/main/open-design/knowledge-peak-map" target="_blank" rel="noopener"><b>03</b><span>SOURCE</span><small>GitHub</small></a><button class="tool" id="snapshot" type="button"><b>04</b><span>EXPORT</span><small id="snapshot-label">截图</small></button></nav>
